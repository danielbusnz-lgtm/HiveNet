...
const colors = {
    ...
    blue: 'bg-ochre-500/15 text-ochre-700 group-data-hover:bg-ochre-500/25 dark:text-ochre-400 dark:group-data-hover:bg-ochre-500/25',
...
export const BadgeButton = forwardRef(function BadgeButton(
    ...
    const classes = clsx(
        className,
        'group relative inline-flex rounded-md focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-ochre-500',
    )
