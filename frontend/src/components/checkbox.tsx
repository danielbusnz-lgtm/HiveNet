...
const base = [
    ...
    // Focus ring
    'group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-ochre-500',
    // Disabled state
...
const colors = {
    ...
    blue: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-ochre-600)] [--checkbox-checked-border:var(--color-ochre-700)]/90',
