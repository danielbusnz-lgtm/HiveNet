        ...
        >
            <span
                ...
                className={clsx([
                    ...
                    'dark:before:hidden',
                    // Focus ring
                    'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent after:ring-inset sm:focus-within:after:ring-2 sm:focus-within:after:ring-ochre-500',
                    // Disabled state
    ...
    return (
        <Headless.ComboboxOption
            ...
            className={clsx(
                ...
                // Focus
                'outline-hidden data-focus:bg-ochre-500 data-focus:text-white',
                // Forced colors mode
