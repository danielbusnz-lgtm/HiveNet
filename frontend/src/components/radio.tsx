...
const base = [
    ...
    // Focus ring
    'group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-ochre-500',
    // Disabled state
...
const colors = {
    ...
    blue: '[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-ochre-600)] [--radio-checked-border:var(--color-ochre-700)]/90',
