...
const colors = {
    ...
    blue: [
        '[--switch-bg-ring:var(--color-ochre-700)]/90 [--switch-bg:var(--color-ochre-600)] dark:[--switch-bg-ring:transparent]',
        '[--switch:white] [--switch-ring:var(--color-ochre-700)]/90 [--switch-shadow:var(--color-ochre-900)]/20',
    ],
    indigo: [
